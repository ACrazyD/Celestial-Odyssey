ServerEvents.recipes(e => {
    ...
    craftingbench('vct:ge_cypress_crafting_table', 'goodending:cypress_log')
    craftingbench('vct:ge_muddy_oak_crafting_table', 'goodending:muddy_oak_log')
    ...
    craftingbench('vct:bm_ancient_oak_crafting_table', 'biomemakeover:ancient_oak_log')
    craftingbench('vct:bm_blighted_balsa_crafting_table', 'biomemakeover:blighted_balsa_log')
    craftingbench('vct:bm_swamp_cypress_crafting_table', 'biomemakeover:swamp_cypress_log')
    craftingbench('vct:bm_willow_crafting_table', 'biomemakeover:willow_log')
